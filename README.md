...
1. **Data Cleaning** — handled missing values, dropped irrelevant and highly correlated columns
2. **EDA** — distribution plots, correlation heatmap, boxplots
3. **Class Balancing** — downsampled majority class to fix imbalance
4. **Model Training** — Random Forest with GridSearchCV hyperparameter tuning (5-fold CV)
5. **Evaluation** — accuracy, confusion matrix, classification report
6. **Export** — model saved as `rainfall_prediction_model.pkl`
